  ...
  <div id="app">
    <div id="title">
      ...
      <div class="right">
        ...
        <a id="CL"><div id="changeL" @click='changeLang()'>CN中 | EN英</div></a>
      </div>
    </div>
